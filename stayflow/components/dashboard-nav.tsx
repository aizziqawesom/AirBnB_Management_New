...
export function DashboardNav({
  ...
  return (
    <div className="min-h-screen">
      {/* Desktop Sidebar */}
      <aside className="fixed left-0 top-0 z-30 hidden h-screen w-64 border-r border-border bg-secondary lg:block">
        <div className="flex h-full flex-col">
          ...
          <div className="border-t border-border px-3 py-4">
            ...
            <Button
              variant="ghost"
              className="w-full justify-start text-muted-foreground hover:bg-accent/10 hover:text-foreground"
